    ...
    <form id="form1" runat="server">
        ...
        <div class="table-responsive">
            <asp:GridView ID="GridViewListeContact" runat="server" class="table" AllowPaging="True" 
                ...
                OnRowUpdating="GridViewListeContact_RowUpdating"
                >
                <Columns>
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ucontactConnectionString %>" SelectCommand="SELECT [idcontact], [Civilite], [Nom], [Prenom]
,
(
case  [DateNaissance]
...
[Adresse], [CP], [Ville], [Pays], [Telephone], [Portable], [Email] FROM [CONTACT] ORDER BY [Nom], [Prenom]" UpdateCommand="select 1+1"></asp:SqlDataSource>
        </div>
